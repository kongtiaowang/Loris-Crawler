...
print("  ALL DONE!")
print("="*60)
print("\n  [Branch Notice for Contributors]")
print("  - Work on the 'main' branch for all code/BIDS structures.")
print("  - The 'git-annex' branch is machine-generated. IGNORE IT.")
print("  - DO NOT submit any Pull Requests (PRs) to 'git-annex'.\n")
